...
class DBconnect {
  ...
  final databaseUrl =
      Uri.parse('https://inquire-24d6d-default-rtdb.firebaseio.com/database.json');

  // HCI endpoint url
  final osUrl =
      Uri.parse('https://inquire-24d6d-default-rtdb.firebaseio.com/operating_systems.json');
