...
class OSPastQuestion extends StatefulWidget {
  const OSPastQuestion({Key? key}) : super(key: key);

  @override
  State<OSPastQuestion> createState() => _OSPastQuestionState();
}

class _OSPastQuestionState extends State<OSPastQuestion> {
  ...
  Future<List<QuestionModel>> getQuestions() async {
    ...
    return dbConnect.getOSQuestions();
  }
